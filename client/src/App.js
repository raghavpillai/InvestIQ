      ...
      <div class="overflow-x-auto">
        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
          <table class="min-w-full leading-normal">
            <thead>
              <tr>
                <th class="px-5 py-3 border-b-1 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                  Company
                </th>
...
function App() {
  ...
  let logolkn =
    "https://1000logos.net/wp-content/uploads/2016/10/Logo-Boeing.png";
          ...
          <div class="grid gap-4 grid-cols-3">
            ...
            <div class="bg-gradient-to-r from-cyan-500 to-blue-500   p-4 bg-white border border-gray-200 rounded-lg shadow-sm col-span-4 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
              <div class="flex items-center justify-between mb-0">
                ...
                <div class="flex items-center justify-end flex-1 text-base font-black text-green-500 dark:text-green-400">
                  {topOverall["ticker"]}
                  &nbsp;
                  <p>{topOverall["overall_rating"]}</p>
                  <svg
                    class="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 20 20"
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center justify-end flex-1 text-base font-medium text-green-500 dark:text-green-400">
                  <img class="w-20 h-18" src={logolkn} alt="CompanyImg" />
                </div>
              </div>

              <div class="flex items-center justify-between mb-4">
                <div class="">
                  <p class="text-3xl leading-none text-gray-900 dark:text-white">
                    <br />
                    Boeing's stock is surging due to the aviation industry's
                    post-pandemic recovery, increased demand for commercial
                    aircraft, successful resolution of 737 MAX issues, and
                    ongoing cost-cutting measures, all of which have boosted
